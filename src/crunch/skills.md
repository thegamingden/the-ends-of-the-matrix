...
When a character utilizes any Operations Program or Complex Form, the dicepool is Logic + Computer (or Resonance + Computer for Complex Forms), regardless of what other parameters it has.
...
When a character utilizes any Attack Program or Complex Form, the dicepool is Logic + Cybercombat (or Resonance + Cybercombat for Complex Forms), regardless of what other parameters it has.
...
| Net hits | Information Gained |
|:--------:|:-------------------|
| 0 | You are aware of the Icon's presence, and can tell if it's a Program or Network. |
| 1 | <ul><li>The general health of the Network (undamaged, damaged, crashed, etc) including how many programs it's sustaining.</li><li>The number of hits sustaining each Program you can see.</li><li>Whether the Network is Occupied or Empty (Technomancers/Sprites/AIs are non-biological but <em>do</em> count as Occupied).</li><li>If you are a Technomancer looking at another Technomancer, you can tell if they follow the Resonance or the Dissonance.</li></ul> |
| 2 | <ul><li>The general class of the Icon, eg: Metahuman PAN, Flirt Sprite, Operations program, and so on.</li><li>How many active Connections a Network has.</li><li>If the Icon is a Network that incorpoates other devices, gives the general category of each device (cyberware, sensor, gun, credstick, etc).</li><li>Whether the Network's Firewall has an IC program running.</li></ul> |
| 3 | <ul><li>You can tell if the Matrix stats (Signal, Response, Firewall, and System) of the Network are higher than, equal to, or lower than your own.</li><li>The exact Program that an Icon reprisents.</li><li>The LTG of a Network or device.</li></ul> |
| 4 | <ul><li>The exact Matrix stats of the Icon.</li><li>The Signal range that each of the Network's connections is traveling across.</li></ul> |

### Analysis

When a character utilizes any Analysis Program or Complex Form, the dicepool is Logic + Data Search (or Resonance + Data Search for Complex Forms), regardless of what other parameters it has.

### Datasearch Specializations
...
When a character utilizes any Communications Program or Complex Form, the dicepool is Logic + Electronic Warfare (or Resonance + Electronic Warfare for a Complex Form), regardless of what other parameters it has.
...
When a character utilizes any Exploit Program or Complex Form, the dicepool is Logic + Hacking (or Resonance + Hacking for a Complex Form), regardless of what other parameters it has. It is important to note that the program "Back Door" is an Exploit Program, which is the most important method that a non-technomancer has to create a connection with an uncooperative network.
